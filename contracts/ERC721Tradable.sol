  ...
  Ownable
{
  ...
  uint256 private _maxTokenIdThatCanBeMigrated = 200; // FIXME set this for real
  ...
  function migrateToken(
    ...
    require(_tokenId < _maxTokenIdThatCanBeMigrated, "Token cannot be migrated because it past the snapshot");
